...
COPY ["src/Gml.Web.Api/src/Gml.Core/src/CmlLib.ExtendedCore/CmlLib/CmlLib.csproj", "src/Gml.Web.Api/src/Gml.Core/src/CmlLib.ExtendedCore/CmlLib/"]
COPY ["src/Gml.Web.Api/src/Gml.Core/src/GmlCore/GmlCore.csproj", "src/Gml.Web.Api/src/Gml.Core/src/GmlCore/"]
COPY ["src/Gml.Web.Api/src/Gml.Common/Gml.Common/Gml.Common.csproj", "src/Gml.Web.Api/src/Gml.Common/Gml.Common/"]
...
COPY ["src/Gml.Web.Api/src/Gml.Core/src/GmlCore.Interfaces/GmlCore.Interfaces.csproj", "src/Gml.Web.Api/src/Gml.Core/src/GmlCore.Interfaces/"]
