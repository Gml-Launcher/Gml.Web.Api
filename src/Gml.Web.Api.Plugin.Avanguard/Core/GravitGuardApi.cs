...
namespace Gml.Web.Api.Plugin.Avanguard.Core;

public static class GravitGuardApi
{
 private const string k32LibName = @"kernel32.dll";
        ...
        public static class AvnApiDelegates
        {
            ...
            public delegate bool _AvnIsFileSigned([MarshalAs(UnmanagedType.LPWStr)] string filePath,
        ...
        public static bool Load(string avnPath)
        {
            ...
            API.AvnRegisterThreatNotifier =
                GetDelegate<AvnApiDelegates._AvnRegisterThreatNotifier>(avnApiPointers.AvnRegisterThreatNotifier);
            API.AvnEliminateThreat =
                GetDelegate<AvnApiDelegates._AvnEliminateThreat>(avnApiPointers.AvnEliminateThreat);
            ...
            API.AvnIsFileProtected =
                GetDelegate<AvnApiDelegates._AvnIsFileProtected>(avnApiPointers.AvnIsFileProtected);
            API.AvnIsFileSigned = GetDelegate<AvnApiDelegates._AvnIsFileSigned>(avnApiPointers.AvnIsFileSigned);
            API.AvnVerifyEmbeddedSignature =
                GetDelegate<AvnApiDelegates._AvnVerifyEmbeddedSignature>(avnApiPointers.AvnVerifyEmbeddedSignature);
            API.AvnIsAddressAllowed =
                GetDelegate<AvnApiDelegates._AvnIsAddressAllowed>(avnApiPointers.AvnIsAddressAllowed);
