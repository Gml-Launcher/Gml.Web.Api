...
{
    public static async Task<IResult> GetUsersRbac(IRbacRepository repo, IMapper mapper)
    {
    ...
    public static async Task<IResult> GetRolesWithPermissions(IRbacRepository repo, IMapper mapper)
    {
    ...
    public static async Task<IResult> GetRoles(IRbacRepository repo, IMapper mapper)
    {
        var roles = await repo.GetAllRolesAsync();
    ...
    public static async Task<IResult> CreateRole(IRbacRepository repo, IMapper mapper, RoleDto dto)
    {
    ...
    public static async Task<IResult> UpdateRole(IRbacRepository repo, IMapper mapper, int id, RoleDto dto)
    {
    ...
    public static async Task<IResult> DeleteRole(IRbacRepository repo, int id)
    {
    ...
    public static async Task<IResult> GetPermissions(IRbacRepository repo, IMapper mapper)
    {
    ...
    public static async Task<IResult> CreatePermission(IRbacRepository repo, PermissionDto dto)
    {
        if (string.IsNullOrWhiteSpace(dto.Name))
    ...
    public static async Task<IResult> UpdatePermission(IRbacRepository repo, int id, PermissionDto dto)
    {
    ...
    public static async Task<IResult> DeletePermission(IRbacRepository repo, int id)
    {
    ...
    public static async Task<IResult> AssignPermissionToRole(IRbacRepository repo, int roleId, int permId)
    {
    ...
    public static async Task<IResult> UnassignPermissionFromRole(IRbacRepository repo, int roleId, int permId)
    {
        // Prevent modifying permissions of Admin role
        var role = await repo.GetRoleByIdAsync(roleId);
        if (role != null && string.Equals(role.Name, "Admin", StringComparison.OrdinalIgnoreCase))
    ...
    public static async Task<IResult> AssignRoleToUser(IRbacRepository repo, int userId, int roleId)
    {
    ...
    public static async Task<IResult> UnassignRoleFromUser(IRbacRepository repo, int userId, int roleId)
    {
