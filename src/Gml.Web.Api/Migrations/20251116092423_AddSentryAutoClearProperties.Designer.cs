...
namespace Gml.Web.Api.Migrations
{
    ...
    [Migration("20251116092423_AddSentryAutoClearProperties")]
    partial class AddSentryAutoClearProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gml.Domains.Settings.Settings", b =>
                {
                    ...
                    b.Property<TimeSpan>("SentryAutoClearPeriod")
                        .HasColumnType("TEXT");

                    b.Property<bool>("SentryNeedAutoClear")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gml.Domains.User.DbUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gml.Domains.Auth.UserRole", b =>
                {
                    ...
                    b.HasOne("Gml.Domains.User.DbUser", "DbUser")
                        .WithMany()
